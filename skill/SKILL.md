...
| ---- | --- | ------------------ |
| Deccan Blue (default) | `#164999` | `[#164999]` |

Use accent at these opacities only:

```
Full:    bg-[#164999]          text-[#164999]
Muted:   bg-[#164999]/60       text-[#164999]/60
Subtle:  bg-[#164999]/20       (backgrounds, tints)
Ghost:   bg-[#164999]/10       (very light tints)
```
