...
:root {
  ...
  --color-accent:       #164999;
  --color-accent-60:    rgba(22, 73, 153, 0.60);
  --color-accent-20:    rgba(22, 73, 153, 0.20);
  --color-accent-10:    rgba(22, 73, 153, 0.10);
...
```
bg-[#164999]      → Primary: buttons, active states, key graphics
bg-[#164999]/60   → Hover states, secondary badges
bg-[#164999]/20   → Section backgrounds, card tints, tag backgrounds
bg-[#164999]/10   → Very subtle tints, hover backgrounds on nav items

text-[#164999]    → Accent text, links, active nav items
text-[#164999]/60 → Softer accent labels
```
...
❌  bg-[#164999] text--[#0EA3DD]  (two accents — pick one, stick with #164999)
❌  bg-[#164999]/5      (too subtle to register)
```
...
<!-- Accent rule -->
<div class="w-8 h-0.5 bg-[#164999] mb-8"></div>
