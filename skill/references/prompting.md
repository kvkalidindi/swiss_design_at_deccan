...
<div class="w-8 h-px bg-[#164999] mb-8"></div>

<!-- Instead of a styled card header image -->
<div class="h-1 bg-[#164999] mb-8 -mx-8 -mt-8"></div>
```
...
**Deccan always uses Deccan Blue `#164999` as the primary accent.** This is the established brand color and must not be changed.
