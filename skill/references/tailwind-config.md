...
:root {
  ...
  --accent: #164999;
  --accent-60: rgba(22, 73, 153, 0.60);
  --accent-20: rgba(22, 73, 153, 0.20);
  --accent-10: rgba(22, 73, 153, 0.10);
}
...
/* Deccan accent is fixed at #164999. Do NOT swap it for another color.
...
For Deccan, the accent is fixed at `#164999` (Deccan Blue). Do not swap it for another color.

```css
:root { --accent: #164999; } /* Deccan Blue */
```

Use `bg-[#164999]`, `text-[#164999]`, `border-[#164999]` throughout your project. For multi-series charts or data visualizations, refer to `references/data-viz.md` which documents an 8-color palette from `outputs/palette.json`.
